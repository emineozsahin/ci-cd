...
Now the demo application is ready. Next, we need to configure Jenkins to automate the Docker image creation. And we will use CloudFormation Template (for AWS) called jenkins-server.yaml for Jenkins Server.
